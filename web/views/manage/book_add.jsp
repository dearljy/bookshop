...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        <h3 class="cart-page-title">书籍后台管理-添加书籍</h3>
        <div class="row">
                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="product-name"><input name="name" style="width: 60%" type="text" value="如雪如山"/></td>
                                <td class="product-name"><input name="author" style="width: 90%" type="text" value="张天翼"/></td>
                                <td class="product-price-cart"><input name="price" style="width: 90%" type="text" value="39.00"/></td>
...
<!--                                    <a href="#"><i class="icon-close"></i></a>-->
                                    <input type="submit" style="width: 90%;background-color: silver;border: silver;border-radius: 20%;" value="添加书籍"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
