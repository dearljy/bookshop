    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            $("button.add-to-cart").click(function (){
                ...
                location.href = "cartServlet?action=add&bookId="+bookId;
            })
                    ...
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <%--查询结果展示--%>
                                <form class="action-form" action="customerBookServlet">
                                    <input type="hidden" name="action" value="pageByBookName">
                                    <input type="hidden" name="pageNo" value="${requestScope.page.pageNo}">
                                    <input class="form-control" name="bookName" placeholder="请输入书籍名" type="text">
                        ...
                        <c:if test="${sessionScope.member != null}">
                            ...
                            <div class="header-bottom-set dropdown">
                                <a href="orderServlet?action=queryAllOrder">订单管理</a>
                            </div>
                            <div class="header-bottom-set dropdown">
                                <a class="logout" href="memberServlet?action=logout">退出登录</a>
                            </div>
                        </c:if>
                        <!-- Single Wedge End -->
                        <a href="cartServlet?action=showCart" id="to-cart" memberId="${sessionScope.member.id}"
                           class="header-action-btn header-action-btn-cart pr-0">
                            <i class="icon-handbag"> 购物车</i>
                            <c:if test="${sessionScope.member.id != null}">
                                <span class="header-action-num">${param.get("totalCount")}</span>
                            </c:if>
                            ...
                            <c:forEach items="${requestScope.page.items}" var="book">
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="#" class="image">
                                                <img src="${book.imgPath}" alt="Product"/>
                                                <img class="hover-image" src="${book.imgPath}"
                                                     alt="Product"/>
                                            </a>
                                            <span class="badges">
                                            ...
                                            <c:if test="${book.stock == 0}">
                                                <button title="Add To Cart" stock="${book.stock}" memberId="${sessionScope.member.id}" bookId="${book.id}" class="add-to-cart【库存不足】">Add
                                                    To Cart
                                                </button>
                                            </c:if>
                                            <c:if test="${book.stock > 0}">
                                                <button title="Add To Cart" memberId="${sessionScope.member.id}" bookId="${book.id}" class="add-to-cart">Add
                                                    To Cart
                                                </button>
                                            </c:if>
                                        </div>
                                        <div class="content">
                                            <h5 class="title">
                                                <a href="shop-left-sidebar.html"> 精 品 书 籍 </a></h5>
                                            <span class="price">
                                                <span class="new">书名:　${book.name}</span>
                                            </span>
                                            <span class="price">
                                                <span class="new">作者:　${book.author}</span>
                                            </span>
                                            <span class="price">
                                                <span class="new">价格:　￥${book.price}</span>
                                            </span>
                                            <span class="price">
                                                <span class="new">销量:　${book.sales}</span>
                                            </span>
                                            <span class="price">
                                                <span class="new">库存:　${book.stock}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        ...
        <c:if test="${requestScope.page.pageNo < requestScope.page.totalRow}">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                <a href="#" class="banner">
                    <img src="assets/images/banner/r1.jpg" alt=""/>
                </a>
            </div>
            <!-- Banner End -->

            <!-- Banner Start -->
            <div class="col-lg-6 col-12 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                <a href="#" class="banner">
                    <img src="assets/images/banner/r4.jpg" alt=""/>
                </a>
            </div>
            <!-- Banner End -->
        </div>
                    ...
                    <div class="col-md-5 col-sm-12 col-xs-12 mb-lm-30px mb-sm-30px">
                        ...
                        <div class="swiper-container gallery-top mb-4">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="assets/images/product-image/r5.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
